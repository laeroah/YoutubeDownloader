...
extern const struct DownloadTaskAttributes {
	...
	__unsafe_unretained NSString *resumeDataPath;
	...
	__unsafe_unretained NSString *videoImageDownloadUrl;
	__unsafe_unretained NSString *videoImagePath;
	__unsafe_unretained NSString *videoTitle;
	__unsafe_unretained NSString *youtubeVideoID;
...
@property (nonatomic, strong) NSString* resumeDataPath;



//- (BOOL)validateResumeDataPath:(id*)value_ error:(NSError**)error_;
...
@property (nonatomic, strong) NSString* videoImageDownloadUrl;



//- (BOOL)validateVideoImageDownloadUrl:(id*)value_ error:(NSError**)error_;
...
//- (BOOL)validateYoutubeVideoID:(id*)value_ error:(NSError**)error_;
...
- (NSString*)primitiveResumeDataPath;
- (void)setPrimitiveResumeDataPath:(NSString*)value;
...
- (NSString*)primitiveVideoImageDownloadUrl;
- (void)setPrimitiveVideoImageDownloadUrl:(NSString*)value;
...
- (NSString*)primitiveYoutubeVideoID;
- (void)setPrimitiveYoutubeVideoID:(NSString*)value;
