...
- (void)layoutSubviews {
	...
	CGSize detailsLabelSize = [self.detailsLabel.text sizeWithFont:self.detailsLabel.font
                                            constrainedToSize:maxSize lineBreakMode:self.detailsLabel.lineBreakMode];
